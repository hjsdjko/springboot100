...
public interface FangwuzulinService extends IService<FangwuzulinEntity> {
    ...
    List<Map<String, Object>> selectValue(Map<String, Object> params,Wrapper<FangwuzulinEntity> wrapper);

    List<Map<String, Object>> selectTimeStatValue(Map<String, Object> params,Wrapper<FangwuzulinEntity> wrapper);

    List<Map<String, Object>> selectGroup(Map<String, Object> params,Wrapper<FangwuzulinEntity> wrapper);
