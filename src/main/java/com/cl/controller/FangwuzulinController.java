...
public class FangwuzulinController {
    ...
    public R page(@RequestParam Map<String, Object> params,FangwuzulinEntity fangwuzulin,
                @RequestParam(required = false) @DateTimeFormat(pattern="yyyy-MM-dd") Date zulinshijianstart,
                @RequestParam(required = false) @DateTimeFormat(pattern="yyyy-MM-dd") Date zulinshijianend,
                @RequestParam(required = false) @DateTimeFormat(pattern="yyyy-MM-dd") Date daoqiriqistart,
                @RequestParam(required = false) @DateTimeFormat(pattern="yyyy-MM-dd") Date daoqiriqiend,
                @RequestParam(required = false) @DateTimeFormat(pattern="yyyy-MM-dd") Date zhifuriqistart,
                @RequestParam(required = false) @DateTimeFormat(pattern="yyyy-MM-dd") Date zhifuriqiend,
        ...
        EntityWrapper<FangwuzulinEntity> ew = new EntityWrapper<FangwuzulinEntity>();
                if(zulinshijianstart!=null) ew.ge("zulinshijian", zulinshijianstart);
                if(zulinshijianend!=null) ew.le("zulinshijian", zulinshijianend);
                if(daoqiriqistart!=null) ew.ge("daoqiriqi", daoqiriqistart);
                if(daoqiriqiend!=null) ew.le("daoqiriqi", daoqiriqiend);
                if(zhifuriqistart!=null) ew.ge("zhifuriqi", zhifuriqistart);
                if(zhifuriqiend!=null) ew.le("zhifuriqi", zhifuriqiend);
    ...
    public R value(@PathVariable("yColumnName") String yColumnName, @PathVariable("xColumnName") String xColumnName,HttpServletRequest request) {
        ...
        List<Map<String, Object>> result = fangwuzulinService.selectValue(params, ew);
    ...
    public R valueDay(@PathVariable("yColumnName") String yColumnName, @PathVariable("xColumnName") String xColumnName, @PathVariable("timeStatType") String timeStatType,HttpServletRequest request) {
        ...
        List<Map<String, Object>> result = fangwuzulinService.selectTimeStatValue(params, ew);
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        for(Map<String, Object> m : result) {
            for(String k : m.keySet()) {
                if(m.get(k) instanceof Date) {
    ...
    public R group(@PathVariable("columnName") String columnName,HttpServletRequest request) {
        ...
        List<Map<String, Object>> result = fangwuzulinService.selectGroup(params, ew);
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        for(Map<String, Object> m : result) {
            for(String k : m.keySet()) {
                if(m.get(k) instanceof Date) {
    ...
    public R count(@RequestParam Map<String, Object> params,FangwuzulinEntity fangwuzulin, HttpServletRequest request){
        String tableName = request.getSession().getAttribute("tableName").toString();
        if(tableName.equals("fangdong")) {
            fangwuzulin.setFangdongzhanghao((String)request.getSession().getAttribute("username"));
        }
        ...
        EntityWrapper<FangwuzulinEntity> ew = new EntityWrapper<FangwuzulinEntity>();
        int count = fangwuzulinService.selectCount(MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, fangwuzulin), params), params));
